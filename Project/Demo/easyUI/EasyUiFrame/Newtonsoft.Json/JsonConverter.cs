...
namespace Newtonsoft.Json
{
	public abstract class JsonConverter
	{
		...
		public virtual void WriteJson(JsonWriter writer, object value, bool isIgnoreCollectionProperty)
		{
			JsonSerializer serializer = new JsonSerializer();

			serializer.Serialize(writer, value, isIgnoreCollectionProperty);
		}
