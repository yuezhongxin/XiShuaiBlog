...
namespace Newtonsoft.Json
{
	...
	public static class JavaScriptConvert
	{
		...
		public static string ToString(DateTime value)
		{
            ...
            if (value < new DateTime(2, 1, 1))
            {
                javaScriptTicks = ConvertDateTimeToJavaScriptTicks(value);
            }
            else
            {
                javaScriptTicks = ConvertDateTimeToJavaScriptTicks(value.AddHours(-(DateTime.Now - DateTime.UtcNow).TotalHours));  
            }
		...
		{
			return SerializeObject(value, false, null);
		}

        public static string SerializeObject(object value, bool isIgnoreCollectionProperty)
		{
			return SerializeObject(value, isIgnoreCollectionProperty, null);
		}

        //public static string SerializeObject(object value, bool isIgnoreCollectionProperty, params JsonConverter[] converters)
        //{
        //    SerializeObject(value, converters);
        //}
		...
		public static string SerializeObject(object value, bool isIgnoreCollectionProperty, params JsonConverter[] converters)
		{
			...
			using (JsonWriter jsonWriter = new JsonWriter(sw))
			{
                ...
                jsonSerializer.Serialize(jsonWriter, value, isIgnoreCollectionProperty);
			}
		...
		public static string SerializeXmlNode(XmlNode node)
		{
			...
			return SerializeObject(node, false, converter);
		}
